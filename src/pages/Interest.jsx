...
const Interest = () => {
  ...
  const url = "https://8c3cc6ac8e639685.mokky.dev/something";
  ...
  return (
    <div className="container mx-auto">
      <div className="flex gap-[10px] items-center">
        <h1 className="text-[20px] mt-[20px] font-semibold mb-[20px] md:text-[35px]">
          Sizni qiziqtirishi mumkin
        </h1>
        <Link
          className="text-[13px] md:text-[20px] pt-[3px] flex items-center gap-[5px] font-semibold text-[#2a8be7]"
          to={"/next"}
        >
        ...
        {data.map((product) => (
          <div key={product.id}>
            <div className="flex justify-between items-start gap-[10px]  flex-col ">
              <div onClick={() => navigate(`/interest/${product.id}`)}>
